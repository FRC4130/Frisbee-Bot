...
public class Robot extends IterativeRobot {
	...
	public void teleopPeriodic() {
		leftDrive1.set(ControlMode.PercentOutput, .5 * primaryJoy.getRawAxis(1));
		rightDrive2.set(ControlMode.PercentOutput, .5 * primaryJoy.getRawAxis(5));
	}
